...
const GameComponent: React.FC<GameComponentProps> = ({ playerName, roomId, onExitGame }) => {
  ...
  return (
    <div className="flex justify-center items-center w-full h-screen bg-gray-900">
      <div className="relative w-[800px] h-[600px] shadow-lg rounded-lg overflow-hidden flex justify-center items-center">
        <div ref={gameRef} className="w-full h-full flex justify-center items-center" />
